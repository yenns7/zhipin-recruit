...
如果用人需求、简历上传、候选人管道或面试安排里选不到目标岗位，先到「招聘管理 → 岗位画像」新建岗位；如果岗位被误关，可以在岗位画像页切到「已关闭岗位」并恢复在招。候选人为空时先上传简历；面试官为空时，管理员去用户管理创建或启用面试官账号，非管理员联系管理员处理。

面试安排只能选择启用中的面试官账号和在招岗位。如果账号被停用或岗位已关闭，先由管理员启用账号，或到岗位画像页恢复在招，再重新安排面试。

如果候选人推进错阶段或误淘汰，在候选人管道右侧使用「修正阶段」，必须填写修正原因。修正会影响当前阶段和 BI 当前存量，但历史流水会保留，后续复盘能看到这次是补救操作。

如果候选人负责人分错，经理或管理员在候选人详情里选择新的招聘专员并填写转派原因。转派后，后续 HR 绩效按新负责人统计，历史推进人仍作为操作留痕保留。

BI 看板里的「责任怎么算」可以直接给主管解释数据：候选人负责人算 HR 绩效，最后推进人算操作留痕，面试反馈人算面试官责任，用人部门按岗位部门聚合。
